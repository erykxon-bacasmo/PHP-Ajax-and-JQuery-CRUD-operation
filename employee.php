...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body add_epmployee">
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="fname" id="name_input" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                    ...
                    <div class="form-group">
                        <label>Phone</label>
                        <input type="number" name="phone" id="phone_input" class="form-control" required>
                    </div>
                </div>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < response.length; i++) {
                        ...
                        tr +=
                            '<a href="#viewEmployeeModal" class="m-1 view" data-toggle="modal" onclick=viewEmployee("' + id + '")><i class="fa" data-toggle="tooltip" title="view">&#xf06e;</i></a>';
                        tr +=
                            '<a href="#editEmployeeModal" class="m-1 edit" data-toggle="modal" onclick=viewEmployee("' + id + '")><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>';
                        tr +=
        ...
        function addEmployee() {
            var name = $('fname, #name_input').val();
            var email = $('email, #email_input').val();
            var phone = $('phone, #phone_input').val();
        ...
        function viewEmployee(id = 2) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('.view_employee #id').val(response.id);
